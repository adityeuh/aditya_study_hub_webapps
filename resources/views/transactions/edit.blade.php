                        ...
                        <form method="post" action="{{ route('transactions.update', $transaction->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-6 form-group form-floating mb-3">
                                    <select class="form-control" name="room_id" id="roomID" required>
                                        ...
                                        <option value="{{ $room->id }}" {{ in_array($room->id,array($transaction->room_id))  ? 'selected' : '' }}>{{ $room->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-2 form-group form-floating mb-3">
                                    <input value="{{ $transaction->price }}" type="price" class="form-control prices" name="price" placeholder="Harga Perbulan" required>
                                ...
                                <div class="col-2 form-group form-floating mb-3">
                                    <input value="{{ $transaction->discount }}" type="discount" class="form-control prices" name="discount" placeholder="Diskon">
                                ...
                                <div class="col-2 form-group form-floating mb-3">
                                    <input value="{{ $transaction->total }}" type="total" class="form-control prices" name="total" placeholder="Total" required>
                            ...
                            <div class="row">
                                <div class="col-3 form-group form-floating mb-3">
                                    <input value="{{ $transaction->customer_name }}" type="text" class="form-control" name="customer_name" placeholder="Nama Penghuni" required>
                                ...
                                <div class="col-3 form-group form-floating mb-3">
                                    <input value="{{ $transaction->customer_phone }}" type="text" class="form-control" name="customer_phone" placeholder="No Telp" required>
                                ...
                                <div class="col-6 form-group form-floating mb-3">
                                    <textarea type="text" class="form-control" name="note" placeholder="Catatan" rows="3">{{ $transaction->note }}</textarea>
